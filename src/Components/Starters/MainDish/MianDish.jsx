...
import { mainD, mainDesh } from '../../../Constant'

const MianDish = () => {
  return (
    <section className=" max-w-7xl mx-auto flex flex-col sm:flex-row-reverse h-full sm:px-16 py-16 sm:py-4">
      {/* left side */}
