...
const AboutBanner = () => {
  return (
    <div className=" w-full py-8">
      <div className=" w-full flex flex-col sm:flex-row px-2 sm:px-16 h-full sm:h-[700px] flex-between ">
        ...
        <div className=" w-full relative flex">
          ...
          <img
            className=" absolute -top-8 right-4 sm:-right-12 h-[200px] opacity-95"
            src={logoTrans}
          />
          {/* josafe */}
          <div className=" w-[300px] h-[200px] flex flex-col gap-2 p-4 bg-white absolute bottom-0 left-4 sm:-left-32">
            <div className="flex justify-start items-center gap-5 p-2 bg-white">
              <div
                style={{ backgroundImage: `url(${josifPhoto})` }}
                className="h-20 w-20 rounded-full"
              ></div>
              <div className="flex flex-col gap-2">
                <h1 className=" text-[#292E36] text-[25px] font-cormo font-extrabold">
                  Josefine
                </h1>
                <p className="text-[#4A4A4A] font-jos text-md font-normal">
                  CEO & Founder
                </p>
              </div>
            </div>
